// to play game use WASD and press SPACE to shoot 
// level 1 aliens (referring to the class Alien)
Alien alien1;
Alien alien2;
Alien alien3;
// level 2 aliens
...
Alien alien7;
Alien alien8;
// level 1 bullets (referring to the class Bullets)
Bullets bullet1;
Bullets bullet2;
Bullets bullet3;
// level 2 bullets
...
void player() {
  ...
  if (bullet1.x < x+40 && bullet1.x > x && bullet1.y > y && bullet1.y < y+40) {
    ...
    bullet2.there = false;
    bullet3.there = false;
    // i refer to the bullets in the array list and say they are false so that they disappear (these are the player's bullets)
    for (Bullets b : bulletList) {
      b.there = false;
    }
  }
  if (bullet2.x+10 < x && bullet1.x > x && bullet2.y > y && bullet2.y < y+40) {
    drawn = false;
    background(0);
    textSize(50);
    fill(255, 0, 0);
  ...
  if (bullet3.x < x+40 && bullet3.x > x && bullet3.y > y && bullet3.y < y+40) {
    drawn = false;
    background(0);
    textSize(50);
    fill(255, 0, 0);
  ...
  if (bullet4.x < x+40 && bullet4.x > x && bullet4.y > y && bullet4.y < y+40) {
    drawn = false;
    println("hit the ship");
    background(0);
    textSize(50);
  ...
  if (bullet5.x < x+40 && bullet5.x > x && bullet5.y > y && bullet5.y < y+40) {
    drawn = false;
    println("hit the ship");
    background(0);
    textSize(50);
  ...
  if (bullet6.x < x+40 && bullet6.x > x && bullet6.y > y && bullet6.y < y+40) {
    drawn = false;
    println("hit the ship");
    background(0);
    textSize(50);
  ...
  if (bullet7.x < x+40 && bullet7.x > x && bullet7.y > y && bullet7.y < y+40) {
    drawn = false;
    println("hit the ship");
    background(0);
    textSize(50);
  ...
  if (bullet8.x < x+40 && bullet8.x > x && bullet8.y > y && bullet8.y < y+40) {
    drawn = false;
    println("hit the ship");
    background(0);
    textSize(50);
  ...
  if (bullet9.x < x+40 && bullet9.x > x && bullet9.y > y && bullet9.y < y+40) {
    drawn = false;
    background(0);
    textSize(50);
    fill(255, 0, 0);
  ...
  if (bullet10.x < x+40 && bullet10.x > x && bullet10.y > y && bullet10.y < y+40) {
    drawn = false;
    background(0);
    textSize(50);
    fill(255, 0, 0);
  ...
  if (bullet11.x < x+40 && bullet11.x > x && bullet11.y > y && bullet11.y < y+40) {
    drawn = false;
    background(0);
    textSize(50);
    fill(255, 0, 0);
  ...
  if (bullet12.x < x+40 && bullet12.x > x && bullet12.y > y && bullet12.y < y+40) {
    drawn = false;
    background(0);
    textSize(50);
    fill(255, 0, 0);
  ...
  if (bullet13.x < x+40 && bullet13.x > x && bullet13.y > y && bullet13.y < y+40) {
    drawn = false;
    background(0);
    textSize(50);
    fill(255, 0, 0);
...
void alien() {
  // this refers to the tab named "Alien" and im calling it to display and move the aliens
  alien1.display();
  alien1.move();
  alien2.display();
  alien2.move();
...
void bullets() {
  // this refers to the tab named "Bullets" and im calling it to display and move the bullets
  bullet1.show();
  bullet1.moveb();
  bullet2.show();
  bullet2.moveb();
...
void collide() {
  ...
  for (Bullets b : bulletList) {
    if (b.x+10 > alien1.xpos && b.y > alien1.ypos-10 && b.y < alien1.ypos+20) {
      alien1.alive = false;
      bullet1.there = false;
    }
    if (b.x+10 > alien2.xpos && b.y > alien2.ypos-10 && b.y < alien2.ypos+20) {
      alien2.alive = false;
      bullet2.there = false;
    }
    if (b.x+10 > alien3.xpos && b.y > alien3.ypos-10 && b.y < alien3.ypos+20) {
      alien3.alive = false;
      bullet3.there = false;
    }
  }
...
void collide2() {
  //within the array list of the bullets that are coming from the player, if they are in the position of the aliens, the alien and its bullet becomes false and disappears 
  for (Bullets b : bulletList) {
    if (b.x+10 > alien4.xpos && b.y > alien4.ypos-10 && b.y < alien4.ypos+20) {
      alien4.alive = false;
      bullet4.there = false;
    }
    if (b.x+10 > alien5.xpos && b.y > alien5.ypos-10 && b.y < alien5.ypos+20) {
      alien5.alive = false;
      bullet5.there = false;
    }
    if (b.x+10 > alien6.xpos && b.y > alien6.ypos-10 && b.y < alien6.ypos+20) {
      alien6.alive = false;
      bullet6.there = false;
    }
    if (b.x+10 > alien7.xpos && b.y > alien7.ypos-10 && b.y < alien7.ypos+20) {
      alien7.alive = false;
      bullet7.there = false;
    }
...
void collide3() {
  // if the player's bullets go past 400, they disappear
  for (Bullets b : bulletList) {
    if (b.x >= 400) {
      b.there = false;
    }
    // if the player's bullets hit a SPECIFIC spot in the boss (between 200 and 220 on the y-axis) then the boss dies
    if (b.x+10 > xboss && b.y > 200 && b.y < 220) {
      ...
      bullet12.there = false;
      bullet13.there = false;
      // when the player defeats all three levels, I congratulate them!
      frameRate(2);
